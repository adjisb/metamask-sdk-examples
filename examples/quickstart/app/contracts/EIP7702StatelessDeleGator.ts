import {Address, encodeAbiParameters, numberToHex} from "viem";
...
const abi = [{
    ...
    "inputs": [{
        ...
        "name": "callType",
        "type": "bytes1"
    }], "name": "UnsupportedCallType", "type": "error"
}, {
    ...
    "anonymous": false,
    "inputs": [{"indexed": true, "internalType": "contract IEntryPoint", "name": "entryPoint", "type": "address"}],
    "name": "SetEntryPoint",
    "type": "event"
}, {
    "anonymous": false,
    ...
    "inputs": [{
        "components": [{
            ...
            "components": [{"internalType": "address", "name": "enforcer", "type": "address"}, {
                "internalType": "bytes",
                "name": "terms",
                "type": "bytes"
            ...
            "name": "signature",
            "type": "bytes"
        }], "internalType": "struct Delegation", "name": "_delegation", "type": "tuple"
    }], "name": "disableDelegation", "outputs": [], "stateMutability": "nonpayable", "type": "function"
}, {
    "inputs": [],
    "name": "eip712Domain",
    ...
    }], "name": "enableDelegation", "outputs": [], "stateMutability": "nonpayable", "type": "function"
}, {
    "inputs": [],
    "name": "entryPoint",
    ...
    "inputs": [{
        "components": [{
            ...
            "name": "callData",
            "type": "bytes"
        }], "internalType": "struct Execution", "name": "_execution", "type": "tuple"
    }], "name": "execute", "outputs": [], "stateMutability": "payable", "type": "function"
}, {
    "inputs": [{"internalType": "ModeCode", "name": "_mode", "type": "bytes32"}, {
        "internalType": "bytes",
    ...
    "inputs": [{
        "components": [{
            ...
            "name": "signature",
            "type": "bytes"
        }], "internalType": "struct PackedUserOperation", "name": "_userOp", "type": "tuple"
    }],
    ...
    "inputs": [{"internalType": "bytes32", "name": "_delegationHash", "type": "bytes32"}],
    ...
    "outputs": [{"internalType": "bytes4", "name": "magicValue_", "type": "bytes4"}],
    "stateMutability": "view",
    "type": "function"
}, {
    ...
    "inputs": [{
        ...
        "type": "bytes[]"
    }], "name": "redeemDelegations", "outputs": [], "stateMutability": "nonpayable", "type": "function"
}, {
    "inputs": [{"internalType": "ModeCode", "name": "_mode", "type": "bytes32"}],
    ...
    "name": "validateUserOp",
    "outputs": [{"internalType": "uint256", "name": "validationData_", "type": "uint256"}],
    "stateMutability": "nonpayable",
    "type": "function"
}, {
    "inputs": [{
...
export const EIP7702StatelessDeleGator = {
    abi,
    address: "0x63c0c19a282a1b52b07dd5a65b58948a07dae32b" as Address
}


export const CALLTYPE_BATCH = 1;
export const EXECTYPE_TRY = 1;
export const ModeCodeBatchTry = numberToHex(CALLTYPE_BATCH | EXECTYPE_TRY << 8, {size: 32})
...
export function encodeExecutions(executions: Execution[]) {
    ...
    }], [executions.map(x => ({...x, value: x.value || 0n}))]);
}
